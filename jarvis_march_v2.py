...
def jarvis_march():
	...
	while ref_point != P0:
		...
		if ref_point is None:
			ref_point = P0
			check_points = remove_points(check_points,ref_point)
		
		print('check_points before sorting',ch)
		ref_point = sort_by_polar_angle(check_points,ref_point)[0]
		print('ref_point',ref_point)
...
if __name__ == '__main__':
	jarvis_march()
	# points = [(4, 4), (1, 1), (2, 2), (0, 0), (1, 2), (3, 3), (3, 1)]
	# sort_by_polar_angle(points,(0,3))
